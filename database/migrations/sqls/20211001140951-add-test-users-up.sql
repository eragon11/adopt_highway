...
-- GOAL assign DC roles for these new users
...
VALUES
    ('SREYNO1', 'Shelley Reynolds', 'Shelley', 'Reynolds', 'Lufkin'),
    ('TMURRAY', 'Tabitha Murray', 'Tabitha', 'Murray', 'Beaumont'),
    ('PSTATON', 'Philip Staton', 'Philip', 'Staton', 'Dallas'),
    ('MHOHLE', 'Mikayla Adare', 'Mikayla', 'Adare', 'Austin'),
    ('SFAHRNEY', 'Stephanie Fahrney', 'Stephanie', 'Fahrney', 'Atlanta');
