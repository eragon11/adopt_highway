...
@Controller('report/pickup')
export class PickupReportController {
    constructor(private readonly service: PickupReportService) {}
    ...
    async admin(
        ...
        const pickupReportOptions: ReportOptions = {
            user: request.user,
        ...
        return this.service.findAllForAdmin(pickupReportOptions);
    }
    ...
    async district(
        ...
        return this.service.findAllForDistrict(pickupReportOptions);
    }
    ...
    async maintenanceSection(
        ...
        return this.service.findAllForMaintenanceOffice(pickupReportOptions);
    }
}
