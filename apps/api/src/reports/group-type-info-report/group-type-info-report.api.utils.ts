...
import { GroupTypeInfoReportOrderByProperties } from './group-type-info-report.query';
...
export abstract class AgreementReportQueryDto extends BaseReportQueryDto {
    @ApiProperty({
        name: 'orderBy',
        required: false,
        enum: GroupTypeInfoReportOrderByProperties,
        default: GroupTypeInfoReportOrderByProperties.type,
    })
    orderBy: GroupTypeInfoReportOrderByProperties;
}
